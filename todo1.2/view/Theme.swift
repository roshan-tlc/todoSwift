...
//                                    Text(Properties.fontFamilyBold).tag(ApplicationTheme.FontFamily.TIMES_NEW_ROMAN)
//                                    Text(Properties.fontFamilyTimesNewRoman).tag(ApplicationTheme.FontFamily.ROBOTO)
//                                }
//
