...
//            }
//            do {
//                return try TodoList.shared.getTodos(status: selectedStatus, parentId: parentId)
//            } catch {
//                toastMessage = "\(error)"
//                isToastVisible.toggle()
//            }
...
//    }
//
//    init(project: APIProject) {
//        self.project = project
//        parentId = project.getId()
//        parentTitle = project.getTitle()
//        do {
//            result = try TodoList.shared.getTodos(status: selectedStatus, parentId: parentId)
//        } catch {
//            toastMessage = "\(error)"
//            isToastVisible.toggle()
//        }
